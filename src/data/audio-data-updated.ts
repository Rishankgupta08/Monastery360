    ...
    languages: {
      ...
      'hi': {
        ...
        tracks: [
          {
            id: 'dubdi-hi-1',
            title: 'सिक्किम का पहला मठ',
            description: 'सिक्किम के सबसे पहले मठ का ऐतिहासिक महत्व जानें',
            duration: '4:40',
            narrator: 'लामा थुकजे',
            category: 'history',
    ...
    languages: {
      ...
      'hi': {
        ...
        tracks: [
          {
            id: 'pemayangtse-hi-1',
            title: 'सिक्किम का प्रमुख मठ',
            description: 'सिक्किम के सबसे पुराने और प्रतिष्ठित मठ की यात्रा',
            duration: '5:10',
            narrator: 'लामा कर्मा',
            category: 'history',
      ...
      'ne': {
        ...
        tracks: [
          {
            id: 'pemayangtse-ne-1',
            title: 'सिक्किमको प्रमुख मठ',
            description: 'सिक्किमको सबैभन्दा पुरानो र प्रतिष्ठित मठको यात्रा',
            duration: '5:20',
            narrator: 'लामा कर्म',
            category: 'history',
...
console.log('🎵 NEW AUDIO DATA LOADED:', audioData.map(m => ({ 
  id: m.id, 
  name: m.name, 
